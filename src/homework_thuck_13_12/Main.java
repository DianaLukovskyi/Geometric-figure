...
public class Main {
     ...
     */
            ...
            Vehicle passengerCar = new PassengerCar("explorer",
                    "ford",
                    2015,
                    "green",
                    "smith",
           ...
           Vehicle truckCar = new Truck("SuperTruck",
                    "Volvo",
                    2020,
                    "red",
                    5000,
            ...
            Vehicle[] autos = {truck, truck1, passengerCar};
            ...
            for (Vehicle vehicle : autos) {
                System.out.println("Vehicle " + vehicle.getManufacturer() + " : " + vehicle.getOwner());
            }
